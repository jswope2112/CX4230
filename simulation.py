...
NAVE_TECHWOOD_N = side(s, "North/Techwood N", NAVE_TECHWOOD_N_LANES, NAVE_TECHWOOD_N_ARR_DIST)

NAVE_TECHWOOD_E_DEP_DISTS = [[1, 0, 0], [0, 1, 0], [0, .5, .5]]
NAVE_TECHWOOD_E_LANES = [lane(NAVE_TECHWOOD_E_DEP_DISTS[0]), lane(NAVE_TECHWOOD_E_DEP_DISTS[1])]
NAVE_TECHWOOD_E_ARR_DIST = [.33, .33, .33]
NAVE_TECHWOOD_E = side(s, "North/Techwood E", NAVE_TECHWOOD_E_LANES, NAVE_TECHWOOD_E_ARR_DIST)
...
NAVE_TECHWOOD_S = side(s, "North/Techwood S", NAVE_TECHWOOD_S_LANES, NAVE_TECHWOOD_S_ARR_DIST)
...
NAVE_TECHWOOD_W = side(s, "North/Techwood W", NAVE_TECHWOOD_W_LANES, NAVE_TECHWOOD_W_ARR_DIST)
